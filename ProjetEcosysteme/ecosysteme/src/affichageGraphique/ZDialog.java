...
public class ZDialog extends JDialog{
	...
	public static int getAnimauxTot() {
		if (Integer.parseInt(getNbreAnimaux()) > tPlateauInt*tPlateauInt/2) {
			return tPlateauInt*tPlateauInt/2;
		} else {
	...
	private void initComponent(){
		...
		okBouton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent arg0) {
				...
				System.out.println(tPlateauChoisi);
				...
				if (environnementChoisi.equals("Savane")){
					System.out.println(tPlateauInt);
					JFrame window = new JFrame("Simulation d'ecosysteme : " + nomSimu + ", Savane");
					Savane sav = new Savane(tPlateauInt);
					sav.creationGrille();
				...
				if (environnementChoisi.equals("Jungle")){
					...
					Jungle jun = new Jungle(tPlateauInt);
					jun.creationGrille();
					window.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
				...
				if (environnementChoisi.equals("Sibérie")){
					...
					Syberie sib = new Syberie(tPlateauInt);
					sib.creationGrille();
					window.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
				...
				if (environnementChoisi.equals("Montagnes")){
					...
					MassifMontagneux massif = new MassifMontagneux(tPlateauInt);
				...
				if (environnementChoisi.equals("Steppes")){
					...
					Steppe steppe = new Steppe (tPlateauInt);
