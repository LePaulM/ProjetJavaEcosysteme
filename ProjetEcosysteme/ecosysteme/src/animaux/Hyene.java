...
public class Hyene extends Charognard{
	 ...
	 * @param meurtFaim
	 */
	public Hyene(int dateNaissance,  Case emplacement, 
	...
	File hyeneFile = new File("./ecosysteme/ressources/hyene.png");
	Icon hyene = new ImageIcon(hyeneFile.getAbsolutePath());
